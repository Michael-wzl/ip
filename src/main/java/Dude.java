...
public class Dude {
     ...
     * @throws DudeException If the task number is missing, not a number, or out of range.
     */
     ...
     *
     * @param input The user input string.
     * @throws DudeException If the description is empty or the task list is full.
     */
